...
import { getGoogleAuthEnabled } from '@/api';
import { getGoogleSignInUrl } from '@/lib/googleAuth';
...
export default function Register() {
  ...
  useEffect(() => {
    void getGoogleAuthEnabled().then(setGoogleEnabled);
  }, []);
          ...
          {googleEnabled && (
            <>
              ...
              <p className="mt-2 text-center text-xs text-muted-foreground">
                Google sign-up creates a <span className="font-medium text-foreground">candidate</span> account.
                Use email registration to join as a company.
              </p>
            </>
          )}
